...
<section id="feature_news_section" class="feature_news_section">
 ...
 <img class="img-responsive top_static_article_img" src="{{ asset('front/img/feature-static1.jpg') }}"  alt="">
                    </div>
                    <!-- feature_article_img -->
                        ...
                        <div class="col-md-6">
                            <div class="top_article_img">
                                <a href="single.html" target="_self">
                                    <img class="img-responsive" src="{{asset('front/img/cat-mobi-left-1.jpg')}}" alt="feature-top">
                                </a>
                            </div>
                            <!----top_article_img------>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="media">
                                <div class="media-left">
                                    <a href="#">
                                        <img class="media-object" src="{{asset('front/img/cat-mobi-sm1.jpg')}}" alt="Generic placeholder image"></a>
                                </div>
